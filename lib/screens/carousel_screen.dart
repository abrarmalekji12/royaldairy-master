               ...
               children: <Widget>[
                 imaged.containsKey(product.productId)
                   ...
                   child: Image.network(
                     ...
                     : Shimmer.fromColors(child: new Image.asset(
                   ...
                   child: Align(
                       ...
                       child: Column(
                         ...
                         children: <Widget>[
                           ...
                           Text("${product.description}",style: TextStyle(fontFamily:"georgia",fontSize: 15),),
                           Padding(padding: EdgeInsets.all(3),),
                           Align(
                             alignment: Alignment.center,
                             child: Text(
                               '${current.shopStore[j].name},${current
                                   .shopStore[j].location.address}',
                               style: TextStyle(
                                 color: Colors.black,
                                 fontSize: 16,
                                 fontFamily: 'arial',
                                 ...
                                 Align(
                                     ...
                                     child: Row(
                                       children: <Widget>[
                                         IconButton(icon: Icon(
                                           ...
                                           if (current.permUser.myCart.products
                                             ...
                                             current.permUser.myCart
                                                 .quantities[current.permUser
                                                 .myCart.products.indexOf(
                                                 product)]-- == 0) {
                                         ...
                                         Text('${current.permUser.myCart.products
                                             .contains(product)
                                             ? current.permUser.myCart
                                             .quantities[current.permUser.myCart
                                         ...
                                         IconButton(icon: Icon(
                                           ...
                                           if (current.permUser.myCart.products
                                             ...
                                             current.permUser.myCart.products.add(
                                                 product);
                                             current.permUser.myCart.quantities
                                                 .add(1);
                                           }
